    ...
    def getElementsList(self, tag, filter=None, elementList=None):
        ...
        if elementList:
            ...
            if self.frameName:
                ...
                if self.formName:
                    elements = myFrame.Document.Body.orms[self.formName].getElementsByTagName(tag)
                else:
                    elements = myFrame.Document.Body.getElementsByTagName(tag)
            else:
                if self.formName:
                    elements = self._ie.Document.Body.forms[self.formName].getElementsByTagName(tag)
                else:
